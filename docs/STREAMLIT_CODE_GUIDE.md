...
[guía de usuario](USER_GUIDE.md). Esta guía no sustituye los
[contratos de datos](architecture/silver_extraction_contract.md) ni la
[especificación pública del producto](APP_PRODUCT_SPEC.md).
...
- [README](../README.md)
- [Contrato Silver](architecture/silver_extraction_contract.md)
- [Especificación pública del producto](APP_PRODUCT_SPEC.md)
- [Resultados finales de evaluación](evaluation/FINAL_HOLDOUT_V2_RESULTS.md)

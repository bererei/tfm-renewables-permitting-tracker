...
\pendiente{Diagrama de adquisición: sumarios y metadatos, filtro de títulos,
XML de candidatos, corpus fuente y bifurcación entre descarte determinista
y extracción con Gemini. Mensaje: recuperar, seleccionar, decidir alcance
y extraer son operaciones distintas; la descarga de XML sigue al filtro.}

...
El Boletín Oficial del Estado (BOE) es el diario oficial estatal en el que se
publican disposiciones y actos administrativos. Para este trabajo resulta
adecuado porque permite consultar publicaciones identificadas, fechadas y
accesibles, con el texto que comunica cada actuación. Su carácter oficial
aporta una fuente documental sobre la que justificar la reconstrucción; no
convierte automáticamente la interpretación realizada por el sistema en una
conclusión jurídica.
\citapendiente{Fuente institucional sobre el BOE, su función y el alcance de
la publicación oficial.}

La unidad publicada es un documento administrativo, no una ficha consolidada
de proyecto renovable. Una planta puede aparecer en varios anuncios y
resoluciones, con nombres abreviados o variantes de escritura, y una misma
publicación puede referirse a varias plantas. El identificador BOE reconoce
la publicación; no identifica de forma estable el proyecto a lo largo del
tiempo. Esta diferencia obliga a recuperar documentos, distinguir sus
entidades y relacionar después las menciones compatibles.

Por ejemplo, las publicaciones de abril y agosto de Don Rodrigo II de la
tabla~\ref{tab:don-rodrigo} corresponden a documentos diferentes de una misma
secuencia administrativa. Consultarlas por separado permite leer cada acto;
reconstruir la secuencia exige reconocer la planta y separar el acto actual
que comunica cada documento de los antecedentes que recuerda. El corpus
construido aquí conserva esa información dispersa para su procesamiento.
Su alcance depende de las publicaciones y periodos seleccionados: no es un
censo exhaustivo de instalaciones ni sustituye otros registros oficiales.

\section{API y adquisición de documentos}
\label{sec:adquisicion-api}
Una interfaz de programación de aplicaciones, o \emph{API}, permite que un
...
La huella documental empleada por la extracción se calcula a partir del
identificador, la fecha de publicación, el título y el texto preparado.
El XML descargado tiene además su propia huella sobre los bytes del archivo.
Son comprobaciones complementarias: conservar el mismo XML y conservar la
misma entrada textual del extractor no son exactamente la misma condición.
Si cambia el texto preparado, cambia la identidad que enlaza el documento con
sus intentos y revisiones, aunque se mantenga el identificador BOE.

Los manifests relacionan esas huellas con archivos, reglas y versiones de
cada etapa. Permiten detectar una entrada incompatible y evitar reutilizar
una extracción como si procediera de otra versión documental. Una huella no
comprueba que el contenido sea verdadero ni que la extracción sea correcta;
comprueba la identidad del contenido utilizado. La selección de texto para
Gemini conserva también una huella propia, descrita en la
...
\begin{tabular}{L{2.0cm} L{2.2cm} L{3.3cm} C{1.0cm} L{3.2cm}}
\hline
Conjunto & Finalidad & Periodo o referencia & BOE & Uso \\
\hline
Desarrollo congelado & Afinar el sistema & Referencia: 13/08/2026 & 140 & Desarrollo y regresión \\
Registro de exposición & Delimitar lo ya conocido & Usos previos a la selección & 479 & Exclusión del holdout \\
Ancla W14 & Actividad reciente & 07/08/2026--20/08/2026 & 48 & Punto de partida del producto \\
Histórico recuperado & Ampliar cronologías & Búsqueda: 01/01/2022--06/08/2026 & 56 & Publicaciones anteriores \\
Corpus final & Construir el producto & Ancla más histórico & 104 & Materialización Silver y Gold \\
Holdout & Evaluar la extracción & Marco: 01/01/2024--20/08/2026 & 48 & Evaluación separada \\
\hline
\end{tabular}
\caption[Conjuntos documentales y funciones]{Conjuntos documentales y funciones. Los intervalos de búsqueda no
...
negativos sin modelo. Para los demás candidatos, Gemini produce conjuntamente
...
casos restantes. La salida se valida antes de utilizarse. Elaboración propia

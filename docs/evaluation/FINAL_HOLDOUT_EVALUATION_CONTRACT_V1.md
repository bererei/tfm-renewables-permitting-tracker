...
| --- | --- |
| System under evaluation | private historical ref `tfm-final` at `282de815bea4e248bdcba2c655e3ee078cb58a49` |
| Extraction configuration | `4b54b89dbfe8640e` |
| Provider/model | `gemini` / `google:gemini-2.5-flash` |
| Evaluation tooling | private historical branch `tfm-evaluation` at the later approved tooling commit |
